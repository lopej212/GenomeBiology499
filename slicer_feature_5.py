...
File: Slicer_feature_5.py
Author: Jose Manuel Lopez Alcala
NOTE:This script is for the 5'UTR
"""
...
input_file_name = "5UTR.txt.dir/5UTR.txt." + str(file_number)
output_file_name = "feature_files_5/features_5." + str(file_number)
...
#Zero otherwise
def startswith_atg(sequenceX,x):
        ...
        while True:
            ...
            if not c:
                ...
                if  not running_string.startswith("S"):
                    ...
                    atg_flag = startswith_atg(running_string,writing_count)
